"""Report writer agent for Ansible analysis workflow.
...
class ReportWriterAgent(BaseAgent[AnsibleAnalysisState]):
    ...
    SYSTEM_PROMPT_NAME = "ansible_analysis_system"
    USER_PROMPT_NAME = "ansible_analysis_task"
